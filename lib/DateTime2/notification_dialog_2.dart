...
class _DateTimeDialogState extends State<DateTimeDialog> {
  ...
  String email2='email loading ...';
  String url2='Image loading ...';
  ...
  void getData() async {
    ...
    setState(() {
      ...
      email2=vari.data()!['email'];
      url2=vari.data()!['photoURL'];
    });
  }
  @override
  void initState() {
  ...
  Future uploadDate() async {
    ...
    await firebaseFirestore
        ...
        .add({'Appointment':selectedDate.toString(),'name':name2,'phone':phone2,'email':email2,'photoURL':url2});
    await firebaseFirestore
        .collection("Doctor")
        .doc("cCo81M4jBnXRJ1KZso0tgBnr6YJ2")
