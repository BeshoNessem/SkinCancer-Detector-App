...
import 'package:flutter_app/DateTime2/data_time_picker_3.dart';
import 'package:intl/intl.dart';

import '../Doctor/data_time_picker_widget2.dart';
import '../view/auth/home_page.dart';
class DoctorDetailPage2 extends StatefulWidget {
  const DoctorDetailPage2({Key? key}) : super(key: key);

  @override
  _DoctorDetailPage2State createState() => _DoctorDetailPage2State();
}

class _DoctorDetailPage2State extends State<DoctorDetailPage2> {
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DateTimePicker3()));
              },
            ),
          ],
        ),
