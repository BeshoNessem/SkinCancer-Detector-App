...
import 'package:flutter_app/DateTime3/data_time_picker_4.dart';
import 'package:flutter_app/Doctor2/home_page.dart';
import 'package:intl/intl.dart';
class DoctorDetailsPage3 extends StatefulWidget {
  const DoctorDetailsPage3({Key? key}) : super(key: key);

  @override
  _DoctorDetailsPage3State createState() => _DoctorDetailsPage3State();
}

class _DoctorDetailsPage3State extends State<DoctorDetailsPage3> {
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DateTimePicker4()));
              },
            ),
          ],
        ),
